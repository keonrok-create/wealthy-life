      ...
      <div className="max-w-lg space-y-5">
        ...
        <Card>
          ...
          <p className="text-navy-100 text-sm leading-relaxed mb-4">
            Wealthy를 홈 화면에 추가하면 앱처럼 빠르게 실행할 수 있어요.
          </p>
        ...
        <Card>
          ...
          <button onClick={handleLogout}
            className="w-full py-2.5 rounded-xl border border-coral/30
                       text-coral text-sm font-bold hover:bg-coral/10 transition-all">
            로그아웃
          </button>
        </Card>
      </div>
